  ...
  return <section id="features" className="py-24 relative">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">VantumAI answers every call, books appointments, follows up with leads, and integrates with your systems — 24/7, without hiring or training anyone.</p>
        </div>
        
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => <Card key={feature.title} className="group bg-slate-800/50 border-slate-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20 backdrop-blur-sm" style={{
