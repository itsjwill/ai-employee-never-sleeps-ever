      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-16">
          {plans.map((plan, index) => (
            <Card 
              key={plan.name}
              className={`relative bg-slate-800/50 border-slate-700/50 backdrop-blur-sm transition-all duration-500 hover:scale-105 hover:shadow-2xl ${
                plan.popular 
                  ? 'ring-2 ring-purple-500/50 hover:ring-purple-400/70 shadow-purple-500/20' 
